<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Personal Details.aspx.cs" Inherits="eLearningWebPortal.Personal_Details" %>
...
<div class="col-md-4">
    ...
    <input type="text" class="form-control" id="ph_no" placeholder="7724979696">
     </div>
      </div>
        </div>
    <div class="row">
    ...
    <input type="text" class="form-control" id="passwd" placeholder="abc">
  </div>
   ...
   <div class="row">
    ...
    <input type="text" class="form-control" id="enrollment_no" placeholder="131311">
  </div>
     </div>
       <div class="col-md-4">
    ...
    <input type="text" class="form-control" id="program" placeholder="Btech">
  </div>
           </div>
       </div>
       <div class="row">
    ...
    <div class=" col-md-3">
  <a href="Profile" class="btn btn-lg btn-primary">Save</a>
